...
public class SpeciesMapleYellow extends Species {
    public static Block leavesBlock = Block.getBlockFromName("sakura:maple_leaves_yellow");
    public static Block logBlock = Block.getBlockFromName("sakura:maple_log");
    public static Block saplingBlock = Block.getBlockFromName("sakura:maple_sapling_yellow");

    public SpeciesMapleYellow(TreeFamily treeFamily) {
        super(new ResourceLocation(info.modid, "mapleyellow"), treeFamily, (ILeavesProperties) ModContent.mapleyellowLeavesProperties);
        ...
        addGenFeature(new FeatureGenFallenLeaves().setFallenLeave(BlockLoader.FALLEN_LEAVES_MAPLE_YELLOW.getDefaultState()));
    }
