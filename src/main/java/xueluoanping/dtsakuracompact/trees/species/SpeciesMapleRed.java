...
public class SpeciesMapleRed extends Species {
    ...
    public static Block saplingBlock = Block.getBlockFromName("sakura:maple_sapling_red:166");

    public SpeciesMapleRed(TreeFamily treeFamily) {
        super(new ResourceLocation(info.modid, "maplered"), treeFamily, (ILeavesProperties) ModContent.mapleredLeavesProperties);
        ...
        addGenFeature(new FeatureGenFallenLeaves().setFallenLeave(BlockLoader.FALLEN_LEAVES_MAPLE_RED.getDefaultState()));
    }
