...
public class SpeciesMapleGreen extends Species {
    public static Block leavesBlock = Block.getBlockFromName("sakura:maple_leaves_green");
    public static Block logBlock = Block.getBlockFromName("sakura:maple_log");
    public static Block saplingBlock = Block.getBlockFromName("sakura:maple_sapling_green");

    public SpeciesMapleGreen(TreeFamily treeFamily) {
        super(new ResourceLocation(info.modid, "maplegreen"), treeFamily,(ILeavesProperties) ModContent.maplegreenLeavesProperties);
...
//        addGenFeature(new FeatureGenPodzol());
        addGenFeature(new FeatureGenFallenLeaves().setFallenLeave(BlockLoader.FALLEN_LEAVES_MAPLE_GREEN.getDefaultState()));
    }
